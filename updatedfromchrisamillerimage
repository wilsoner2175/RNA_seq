...
RUN apt-get update && apt-get install -y --no-install-recommends locales && \
   ...
   RUN Rscript -e "install.packages('bsseq')"
   RUN Rscript -e "install.packages('DelayedArray')"
   RUN Rscript -e "install.packages('DESeq2')"
   RUN Rscript -e "install.packages('GenomicRanges')"
   RUN Rscript -e "install.packages('IRanges')"
   RUN Rscript -e "install.packages('methods')"
   RUN Rscript -e "install.packages('utils')"
   RUN Rscript -e "install.packages('DelayedArray')"
   RUN Rscript -e "install.packages('tximportData')"
